(function initSantaConquistaData(root, factory) {
  ...
  const provinceList = [
    ...
    ['tripoli', 'Tripoli', 'tripoli_county', 1078, 702, 60, 48, ['antioch', 'acre', 'damascus'], 'coast', 'catholic', 'levantina'],
    ['acre', 'Acre', 'jerusalem_kingdom', 1088, 750, 56, 44, ['tripoli', 'jerusalem', 'damascus'], 'coast', 'catholic', 'levantina'],
    ['jerusalem', 'Jerusalem', 'jerusalem_kingdom', 1138, 744, 58, 50, ['acre', 'damascus', 'cairo'], 'hills', 'catholic', 'levantina'],
    ['aleppo', 'Alepo', 'aleppo', 1168, 624, 62, 54, ['edessa', 'antioch', 'damascus', 'mosul'], 'plains', 'sunni', 'arabe-siria'],
    ['damascus', 'Damasco', 'damascus', 1160, 704, 64, 56, ['tripoli', 'acre', 'jerusalem', 'aleppo', 'mosul'], 'plains', 'sunni', 'arabe-siria'],
    ...
    ['cairo', 'Cairo', 'egypt', 1000, 724, 78, 56, ['alexandria', 'jerusalem'], 'river', 'shia', 'egipcia'],
